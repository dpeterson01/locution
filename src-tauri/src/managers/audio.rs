...
impl AudioRecordingManager {
    ...
    /// Binding id of the in-flight recording, if any. Used by the overlay's
    /// manual Record toggle so a stop targets whichever binding started it.
    pub fn active_recording_binding(&self) -> Option<String> {
